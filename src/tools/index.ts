...
export class ToolRegistry {
  ...
  private registerBuiltinTools(): void {
    ...
    this.register({
      name: "list_files",
      description:
        "List files in a directory. Use pattern to filter by glob (e.g., '**/*.ts' for all TypeScript files).",
      parameters: {
        type: "object",
        properties: {
          path: {
    ...
    this.register({
      name: "read_file",
      description:
        "Read the contents of a file. Returns the full content or a specific line range.",
      parameters: {
        type: "object",
        properties: {
          path: {
    ...
    this.register({
      name: "search_code",
      description:
        "Search for a pattern (regex or string) across files. Returns matching lines with context.",
      parameters: {
        type: "object",
        properties: {
          pattern: {
    ...
    this.register({
      name: "write_doc",
      description:
        "Save a documentation section to memory. Use this when you've understood something well enough to document it.",
      parameters: {
        type: "object",
        properties: {
          title: {
    ...
    this.register({
      name: "add_insight",
      description:
        "Record a key insight about the codebase. Use this for important patterns or discoveries.",
      parameters: {
        type: "object",
        properties: {
          insight: {
    ...
    this.register({
      ...
      description:
        "Mark a file as analyzed with a summary. Helps avoid re-analyzing the same file.",
      parameters: {
        type: "object",
        properties: {
          path: {
